var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", "content/Metronic/assets/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", "content/Metronic/assets/frontend/onepage/img/logo/" + color + ".png");
        }
